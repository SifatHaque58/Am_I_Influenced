...
export const AIAnalysisCard: React.FC = () => {
  ...
  const getFullShareText = () => {
    ...
    const categoriesText = selectedCategories.length > 0 
      ? `Based on answers regarding ${selectedCategories.join(', ')}` 
      : 'Based on answers regarding general daily life';
      
    return `📊 My Influence Profile - AI Analysis\n\n${text}\n\n* Disclaimer: This AI analysis is ${categoriesText} and does not constitute a clinical psychological diagnosis.\n* Generated by Am I Influenced`;
  };
    ...
    <div className="mt-6 md:mt-8 px-2 sm:px-0">
      ...
      {analysis && (
        ...
        >
          ...
          <div ref={contentRef} className="markdown-content prose prose-sm sm:prose-base prose-slate max-w-none prose-headings:text-slate-800 prose-headings:font-bold prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600 prose-strong:text-primary-700 prose-strong:font-bold prose-ul:pl-4 sm:prose-ul:pl-6 break-words">
