...
export const AIAnalysisCard: React.FC = () => {
  const { engineScores, age, selectedCategories } = useStore();
        ...
        >
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed">
              <strong>* Disclaimer:</strong> This AI analysis is based {selectedCategories.length > 0 ? `specifically on your answers regarding ${selectedCategories.join(', ')}` : 'on your answers regarding general daily life'} and does not constitute a clinical psychological diagnosis.
            </p>
          </div>
